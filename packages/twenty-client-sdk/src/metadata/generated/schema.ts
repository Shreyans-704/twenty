...
export interface FieldFilter {
  ...
  isSystem?: BooleanFieldComparison | null;
  isUIReadOnly?: BooleanFieldComparison | null;
  objectMetadataId?: UUIDFilterComparison | null;
}
...
export interface QueryGenqlSelection {
  ...
  connectedAccountById?: ConnectedAccountPublicDTOGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  ...
  chatStreamCatchupChunks?: ChatStreamCatchupChunksGenqlSelection & {
    __args: { threadId: Scalars['UUID'] };
  };
  ...
  getAdminAiUsageByWorkspace?: UsageBreakdownItemGenqlSelection & {
    __args?: {
  ...
  findMarketplaceAppDetail?: MarketplaceAppDetailGenqlSelection & {
    __args: { universalIdentifier: Scalars['String'] };
  };
...
export interface UsageAnalyticsInput {
  ...
  periodEnd?: Scalars['DateTime'] | null;
  userWorkspaceId?: Scalars['String'] | null;
  operationTypes?: UsageOperationType[] | null;
}
...
export interface MutationGenqlSelection {
  ...
  createManyNavigationMenuItems?: NavigationMenuItemGenqlSelection & {
    __args: { inputs: CreateNavigationMenuItemInput[] };
  };
  createNavigationMenuItem?: NavigationMenuItemGenqlSelection & {
    __args: { input: CreateNavigationMenuItemInput };
  };
  updateManyNavigationMenuItems?: NavigationMenuItemGenqlSelection & {
    __args: { inputs: UpdateOneNavigationMenuItemInput[] };
  };
  updateNavigationMenuItem?: NavigationMenuItemGenqlSelection & {
    __args: { input: UpdateOneNavigationMenuItemInput };
  };
  deleteManyNavigationMenuItems?: NavigationMenuItemGenqlSelection & {
    __args: { ids: Scalars['UUID'][] };
  };
  deleteNavigationMenuItem?: NavigationMenuItemGenqlSelection & {
    __args: { id: Scalars['UUID'] };
  };
  uploadAIChatFile?: FileWithSignedUrlGenqlSelection & {
    __args: { file: Scalars['Upload'] };
  };
  uploadWorkflowFile?: FileWithSignedUrlGenqlSelection & {
    __args: { file: Scalars['Upload'] };
  };
  uploadWorkspaceLogo?: FileWithSignedUrlGenqlSelection & {
    __args: { file: Scalars['Upload'] };
  };
  uploadWorkspaceMemberProfilePicture?: FileWithSignedUrlGenqlSelection & {
    __args: { file: Scalars['Upload'] };
  };
  uploadFilesFieldFile?: FileWithSignedUrlGenqlSelection & {
    __args: { file: Scalars['Upload']; fieldMetadataId: Scalars['String'] };
  };
  uploadFilesFieldFileByUniversalIdentifier?: FileWithSignedUrlGenqlSelection & {
    __args: {
      file: Scalars['Upload'];
  ...
  resetPageLayoutWidgetToDefault?: PageLayoutWidgetGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  resetPageLayoutTabToDefault?: PageLayoutTabGenqlSelection & {
    __args: { id: Scalars['String'] };
  };
  ...
  updateManyViewGroups?: ViewGroupGenqlSelection & {
    __args: { inputs: UpdateViewGroupInput[] };
  };
  ...
  sendChatMessage?: SendChatMessageResultGenqlSelection & {
    __args: {
      threadId: Scalars['UUID'];
      text: Scalars['String'];
      messageId: Scalars['UUID'];
      browsingContext?: Scalars['JSON'] | null;
  ...
  sendEmail?: SendEmailOutputGenqlSelection & {
    __args: { input: SendEmailInput };
  };
  ...
  setAdminAiModelsEnabled?: {
    __args: { modelIds: Scalars['String'][]; enabled: Scalars['Boolean'] };
  };
  setAdminAiModelRecommended?: {
    __args: { modelId: Scalars['String']; recommended: Scalars['Boolean'] };
  };
  setAdminAiModelsRecommended?: {
    __args: { modelIds: Scalars['String'][]; recommended: Scalars['Boolean'] };
  };
...
export interface UpdatePageLayoutWidgetInput {
  pageLayoutTabId?: Scalars['UUID'] | null;
  title?: Scalars['String'] | null;
...
export interface UpdateObjectPayload {
  ...
  isLabelSyncedWithName?: Scalars['Boolean'] | null;
  isSearchable?: Scalars['Boolean'] | null;
}
...
export interface SendEmailInput {
  connectedAccountId: Scalars['String'];
  to: Scalars['String'];
  cc?: Scalars['String'] | null;
  bcc?: Scalars['String'] | null;
  subject: Scalars['String'];
  body: Scalars['String'];
  inReplyTo?: Scalars['String'] | null;
}
...
export interface SubscriptionGenqlSelection {
  ...
  onAgentChatEvent?: AgentChatEventGenqlSelection & {
    __args: { threadId: Scalars['UUID'] };
  };
  __typename?: boolean | number;
  __scalar?: boolean | number;
...
const EmailThreadConfiguration_possibleTypes: string[] = [
  'EmailThreadConfiguration',
];
export const isEmailThreadConfiguration = (
  obj?: { __typename?: any } | null,
): obj is EmailThreadConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isEmailThreadConfiguration"');
...
const RecordTableConfiguration_possibleTypes: string[] = [
  'RecordTableConfiguration',
];
export const isRecordTableConfiguration = (
  obj?: { __typename?: any } | null,
): obj is RecordTableConfiguration => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isRecordTableConfiguration"');
...
const ClientConfigMaintenanceMode_possibleTypes: string[] = [
  'ClientConfigMaintenanceMode',
];
export const isClientConfigMaintenanceMode = (
  obj?: { __typename?: any } | null,
): obj is ClientConfigMaintenanceMode => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isClientConfigMaintenanceMode"');
...
export const isMaintenanceMode = (
  obj?: { __typename?: any } | null,
): obj is MaintenanceMode => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMaintenanceMode"');
...
export const isMarketplaceAppDetail = (
  obj?: { __typename?: any } | null,
): obj is MarketplaceAppDetail => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isMarketplaceAppDetail"');
...
const CommandMenuItemPayload_possibleTypes: string[] = [
  'PathCommandMenuItemPayload',
  'ObjectMetadataCommandMenuItemPayload',
];
export const isCommandMenuItemPayload = (
  obj?: { __typename?: any } | null,
): obj is CommandMenuItemPayload => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isCommandMenuItemPayload"');
  return CommandMenuItemPayload_possibleTypes.includes(obj.__typename);
};

const PathCommandMenuItemPayload_possibleTypes: string[] = [
  'PathCommandMenuItemPayload',
];
export const isPathCommandMenuItemPayload = (
  obj?: { __typename?: any } | null,
): obj is PathCommandMenuItemPayload => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isPathCommandMenuItemPayload"');
  return PathCommandMenuItemPayload_possibleTypes.includes(obj.__typename);
};

const ObjectMetadataCommandMenuItemPayload_possibleTypes: string[] = [
  'ObjectMetadataCommandMenuItemPayload',
];
export const isObjectMetadataCommandMenuItemPayload = (
  obj?: { __typename?: any } | null,
): obj is ObjectMetadataCommandMenuItemPayload => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isObjectMetadataCommandMenuItemPayload"',
    );
  return ObjectMetadataCommandMenuItemPayload_possibleTypes.includes(
    obj.__typename,
  );
};
...
const PublicConnectionParametersOutput_possibleTypes: string[] = [
  'PublicConnectionParametersOutput',
];
export const isPublicConnectionParametersOutput = (
  obj?: { __typename?: any } | null,
): obj is PublicConnectionParametersOutput => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isPublicConnectionParametersOutput"',
    );
  return PublicConnectionParametersOutput_possibleTypes.includes(
    obj.__typename,
  );
};

const PublicImapSmtpCaldavConnectionParameters_possibleTypes: string[] = [
  'PublicImapSmtpCaldavConnectionParameters',
];
export const isPublicImapSmtpCaldavConnectionParameters = (
  obj?: { __typename?: any } | null,
): obj is PublicImapSmtpCaldavConnectionParameters => {
  if (!obj?.__typename)
    throw new Error(
      '__typename is missing in "isPublicImapSmtpCaldavConnectionParameters"',
    );
  return PublicImapSmtpCaldavConnectionParameters_possibleTypes.includes(
    obj.__typename,
  );
};

const ConnectedAccountPublicDTO_possibleTypes: string[] = [
  'ConnectedAccountPublicDTO',
];
export const isConnectedAccountPublicDTO = (
  obj?: { __typename?: any } | null,
): obj is ConnectedAccountPublicDTO => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isConnectedAccountPublicDTO"');
...
export const isSendEmailOutput = (
  obj?: { __typename?: any } | null,
): obj is SendEmailOutput => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isSendEmailOutput"');
...
const ChatStreamCatchupChunks_possibleTypes: string[] = [
  'ChatStreamCatchupChunks',
];
export const isChatStreamCatchupChunks = (
  obj?: { __typename?: any } | null,
): obj is ChatStreamCatchupChunks => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isChatStreamCatchupChunks"');
...
export const isSendChatMessageResult = (
  obj?: { __typename?: any } | null,
): obj is SendChatMessageResult => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isSendChatMessageResult"');
...
export const isAgentChatEvent = (
  obj?: { __typename?: any } | null,
): obj is AgentChatEvent => {
  if (!obj?.__typename)
    throw new Error('__typename is missing in "isAgentChatEvent"');
...
export const enumFeatureFlagKey = {
  ...
  IS_MARKETPLACE_SETTING_TAB_VISIBLE:
    'IS_MARKETPLACE_SETTING_TAB_VISIBLE' as const,
  IS_RECORD_PAGE_LAYOUT_EDITING_ENABLED:
